...
-- //INFM
insert into course_lookup(course_code,course_name,major_code,course_rating,credits,description) values ("INFM600","INFM600 - Information Environments","INFM",1,3,"Role and function of information in organizations. Organizational environment and its influence on internal and external communication, organizational structure and management, organizational culture, information flow, organizational identity. Shared mental models and group decision ma king. Differences among types of organizations. Information policy.");
insert into course_lookup(course_code,course_name,major_code,course_rating,credits,description) values ("INFM603","INFM603 - Information Technology and Organizational Context","INFM",2,3,"Application of communication and information technologies to support work processes, including technology-enhanced communication networks, computer-supported collaborative work, decision-support systems, interactive systems, and systems analysis. Acquisition of information systems and their integration into the organization.");
insert into course_lookup(course_code,course_name,major_code,course_rating,credits,description) values ("INFM605","INFM605 - Users and Use Context","INFM",4,3,"Use of information by individuals. Nature of information. Information behavior and mental models. Characteristics of problems, task analysis, problem solving, and decision making. Methods for determining information behavior and user needs. Information access. Information technology as a tool in information use.");
insert into course_lookup(course_code,course_name,major_code,course_rating,credits,description) values ("INFM612","INFM612 - Management of Information Program and Services","INFM",5,3,"Administration of information programs, services, and projects, including the role of leadership in management; developing mission, vision, and goals; providing effective management for results; managing professionals; financial management; and professional conduct and ethical issues.");
